...
public class QSeat extends EntityPathBase<Seat> {
    ...
    private static final long serialVersionUID = -123057855L;
    ...
    public final movie_reservation.types.QSeatNumber seatNumber;

    public final EnumPath<movie_reservation.types.SeatState> state = createEnum("state", movie_reservation.types.SeatState.class);
    ...
    public QSeat(Class<? extends Seat> type, PathMetadata metadata, PathInits inits) {
        ...
        this.seatNumber = inits.isInitialized("seatNumber") ? new movie_reservation.types.QSeatNumber(forProperty("seatNumber")) : null;
